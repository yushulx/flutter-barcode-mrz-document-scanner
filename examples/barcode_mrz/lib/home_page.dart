      ...
      children: [
        Container(
          ...
          child: const SizedBox(
            width: 271,
            child: Text(
              'Scan MRZ and barcode with Dynamsoft Capture Vision',
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Image.asset("images/icon-camera.png", width: 90, height: 60),
                const Text(
                  "Camera Scan",
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                Image.asset("images/icon-image.png", width: 90, height: 60),
                const Text(
                  "Image Scan",
                  overflow: TextOverflow.ellipsis,
                  style: TextStyle(fontSize: 16, color: Colors.white),
